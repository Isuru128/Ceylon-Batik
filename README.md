...
```text
mongodb+srv://isurudula28_db_user:<db_password>@ceylonbatik.jmlmfzy.mongodb.net/?appName=ceylonBatik
```

Environment variables:

```text
MONGODB_URI=mongodb+srv://isurudula28_db_user:<db_password>@ceylonbatik.jmlmfzy.mongodb.net/?appName=ceylonBatik
MONGODB_DATABASE=ceylonbatik
```

PowerShell example:

```powershell
$env:MONGODB_URI="mongodb+srv://isurudula28_db_user:<db_password>@ceylonbatik.jmlmfzy.mongodb.net/?appName=ceylonBatik"
$env:MONGODB_DATABASE="ceylonbatik"
.\mvnw.cmd spring-boot:run
```

Products are exposed through:
